...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"requests" | "professionals">(
    "requests",
  );
  ...
  const [assigningProfessional, setAssigningProfessional] = useState<
    string | null
  >(null);
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          language === "en"
            ...
            : "Professionnel assigné avec succès!",
        );
      }
    } catch (error) {
      ...
      alert(
        language === "en"
          ...
          : "Erreur lors de l'affectation du professionnel",
      );
    }
  };
  ...
  const fetchProfessionals = async () => {
    try {
      ...
      const response = await fetch(
        `/api/professionals?admin=true&_t=${Date.now()}`,
      );
      if (response.ok) {
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm text-gray-600">
                {language === "en" ? "Logged in as" : "Connecté en tant que"}
              </p>
                    ...
                    return (
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <span
                            className={`mt-1 inline-block px-3 py-1 text-sm rounded-full ${getStatusColor(request.status)}`}
                          >
                            {getStatusText(request.status)}
                          </span>
                        </div>
                        <div className="pt-4 border-t">
                          ...
                          {request.assignedProfessional ? (
                            <div className="bg-gray-50 p-3 rounded-lg mb-3">
                              ...
                              <p className="text-gray-600 text-sm">
                                {request.assignedProfessional.title || "-"}
                              </p>
                            </div>
                          ) : (
                          ...
                          <button
                            onClick={() =>
                              setAssigningProfessional(request._id)
                            }
                            className="w-full bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition"
                          >
                            {language === "en"
                              ? "Assign / Change Professional"
                              : "Assigner / Changer le Professionnel"}
                          </button>
                        </div>
                        <div className="pt-4 border-t">
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateFormField("avatar", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-gray-900 bg-white"
                  ...
                  <div>
                    ...
                    <select
                      value={
                        professionalModal.data.isActive ? "active" : "inactive"
                      }
                      onChange={(e) =>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder={
                        language === "en"
                          ? "e.g. English, French, Wolof"
                          : "ex: Anglais, Français, Wolof"
                      }
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder={
                        language === "en"
                          ? "e.g. Web Development, Mobile Development"
                          : "ex: Développement Web, Développement Mobile"
                      }
                    />
                  </div>
                </div>
