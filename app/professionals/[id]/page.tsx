      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            {language === 'en' ? 'Professional not found' : 'Professionnel non trouvé'}
          </h1>
          <Link href="/professionals" className="text-emerald-600 hover:underline">
            {language === 'en' ? 'Back to professionals' : 'Retour aux professionnels'}
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* About Section */}
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t.aboutSection}</h2>
